        ...
        <div id="content">
            ...
            <section class="forms-section">
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Recognition</h4>
                    <form action="#" method="post">
                        <div class="form-group">
                            <label>Recognition title</label>
                            <input type="text" class="form-control" id="txtRecognitionTitle" placeholder="i.e xyz recognition" required="">
                        </div>
                        <div class="form-group">
                            <label>Under section</label>
                            <input type="text" class="form-control" id="txtUnderSection" placeholder="Under section" required="">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="txtRecogitionDate" placeholder="date of recognition" required="">  
                            </div>
                            <div class="form-group col-md-6">
