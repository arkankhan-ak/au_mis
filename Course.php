        ...
        <div id="content">
            ...
            <section class="forms-section">
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Course</h4>
                    <form action="#" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Activity with direct bearing</label>
                                <select id="optActWithBearing" class="form-control">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="optCourseType" class="form-control">
                                    <option selected="">Choose...</option>
                                    <option>Short</option>
                                    <option>Long</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="optCourseCategory" class="form-control">
                                    <option selected="">Choose...</option>
                                    <option>...</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select id="optYearOfIntro" class="form-control">
                                    <option selected="">Choose...</option>
                                    <option>...</option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="txtProgramCode" placeholder="Program code">
                            </div>
                            <div class="form-group col-md-6">
